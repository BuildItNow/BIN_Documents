define(
{
	name        : "bin-demo",			// Name of the application
	...
	classConfig:
	{
		...
		core:
		{
			Application:"application/application",	// Change to your own application class
	...
	componentConfig:
	{
		// Uncomment status to see custom status
		//status : "view!component/statusView",
	}
});
